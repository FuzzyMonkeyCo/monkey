...
func (Method) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{0}
}
...
func (YmlCfg_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{0, 0}
}
...
func (Schema_JSONDraft05_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{10, 0, 0}
}
...
func (*YmlCfg_Exec) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{0, 1}
}
...
func (*InitFuzzing) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{1}
}
...
func (*SpecIR) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{2}
}
...
type Schemas struct {
	...
	Schemas_JSONDraft05  map[string]*PtrOrSchemaJSONDraft05 `protobuf:"bytes,1,rep,name=schemas_JSONDraft05,json=schemasJSONDraft05" json:"schemas_JSONDraft05,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func (*Schemas) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{3}
}
...
func (*Endpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{4}
}
...
func (*EndpointJSONDraft05) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{5}
}
...
func (*Path) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{6}
}
...
func (*Path_PathPartial) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{6, 0}
}
...
type Path_PathPartial_Ptr struct {
	Ptr string `protobuf:"bytes,2,opt,name=ptr,oneof"`
}
...
type ParamsJSONDraft05 struct {
	...
	Header map[string]*ParamJSONDraft05 `protobuf:"bytes,1,rep,name=header" json:"header,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// map<uint32,ParamJSONDraft05> path = 2;
	Path map[string]*ParamJSONDraft05 `protobuf:"bytes,2,rep,name=path" json:"path,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// map<uint32,ParamJSONDraft05> body = 3;
	Body map[string]*ParamJSONDraft05 `protobuf:"bytes,3,rep,name=body" json:"body,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// map<uint32,ParamJSONDraft05> query = 4;
	Query                map[string]*ParamJSONDraft05 `protobuf:"bytes,4,rep,name=query" json:"query,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*ParamsJSONDraft05) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{7}
}
...
func (*ParamJSONDraft05) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{8}
}
...
func (*PtrOrSchemaJSONDraft05) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{9}
}
...
type PtrOrSchemaJSONDraft05_Ptr struct {
	Ptr string `protobuf:"bytes,1,opt,name=ptr,oneof"`
}
...
func (*Schema) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{10}
}
...
type Schema_JSONDraft05 struct {
	Type []Schema_JSONDraft05_Type `protobuf:"varint,1,rep,packed,name=type,enum=main.Schema_JSONDraft05_Type" json:"type,omitempty"`
...
func (*Schema_JSONDraft05) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{10, 0}
}
...
func (*Schema_JSONDraft05_AdditionalProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{10, 0, 1}
}
...
func (*JSON) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11}
}
...
type JSON_Object struct {
	...
	IsObject             bool                   `protobuf:"varint,2,opt,name=is_object,json=isObject" json:"is_object,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*JSON_Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 0}
}
...
type JSON_Array struct {
	...
	IsArray              bool          `protobuf:"varint,2,opt,name=is_array,json=isArray" json:"is_array,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*JSON_Array) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 1}
}
...
type JSON_Text struct {
	...
	IsText               bool     `protobuf:"varint,2,opt,name=is_text,json=isText" json:"is_text,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*JSON_Text) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 2}
}
...
type JSON_Number struct {
	...
	IsNumber             bool     `protobuf:"varint,2,opt,name=is_number,json=isNumber" json:"is_number,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*JSON_Number) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 3}
}
...
type JSON_Boolean struct {
	...
	IsBoolean            bool     `protobuf:"varint,2,opt,name=is_boolean,json=isBoolean" json:"is_boolean,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*JSON_Boolean) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 4}
}
...
func (*JSON_Null) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 5}
}
...
func (*JSON_Value) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_41a028af50228858, []int{11, 6}
}
...
type JSON_Value_Z struct {
	Z *JSON_Null `protobuf:"bytes,1,opt,name=z,oneof"`
}
type JSON_Value_B struct {
	B *JSON_Boolean `protobuf:"bytes,2,opt,name=b,oneof"`
}
type JSON_Value_N struct {
	N *JSON_Number `protobuf:"bytes,3,opt,name=n,oneof"`
}
type JSON_Value_T struct {
	T *JSON_Text `protobuf:"bytes,4,opt,name=t,oneof"`
}
type JSON_Value_A struct {
	A *JSON_Array `protobuf:"bytes,5,opt,name=a,oneof"`
}
type JSON_Value_O struct {
	O *JSON_Object `protobuf:"bytes,6,opt,name=o,oneof"`
}
...
func init() { proto.RegisterFile("messages.proto", fileDescriptor_messages_41a028af50228858) }

var fileDescriptor_messages_41a028af50228858 = []byte{
	...
	,
}
