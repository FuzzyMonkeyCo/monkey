...
// protoc-gen-go-vtproto version: v0.2.1-0.20220412081545-eabc7615daf8
...
func (this *Clt_Fuzz_Resetter) EqualVT(that *Clt_Fuzz_Resetter) bool {
	...
	for i := range this.Provides {
		if this.Provides[i] != that.Provides[i] {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *Srv_FuzzingResult) EqualVT(that *Srv_FuzzingResult) bool {
	...
	for i := range this.Counterexample {
		if !this.Counterexample[i].EqualVT(that.Counterexample[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *SpecIR) EqualVT(that *SpecIR) bool {
	...
	for i := range this.Endpoints {
		if !this.Endpoints[i].EqualVT(that.Endpoints[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *Schemas) EqualVT(that *Schemas) bool {
	...
	for i := range this.Json {
		if !this.Json[i].EqualVT(that.Json[i]) {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *EndpointJSON) EqualVT(that *EndpointJSON) bool {
	...
	for i := range this.PathPartials {
		if !this.PathPartials[i].EqualVT(that.PathPartials[i]) {
			return false
		}
	}
	...
	for i := range this.Outputs {
		if this.Outputs[i] != that.Outputs[i] {
			return false
		}
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *Schema_JSON) EqualVT(that *Schema_JSON) bool {
	...
	for i := range this.Enum {
		if equal, ok := interface{}(this.Enum[i]).(interface{ EqualVT(*structpb.Value) bool }); ok {
	...
	for i := range this.Properties {
		if this.Properties[i] != that.Properties[i] {
			return false
		}
	}
	...
	for i := range this.Required {
		if this.Required[i] != that.Required[i] {
			return false
		}
	}
